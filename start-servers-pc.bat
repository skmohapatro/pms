...
start "Chat Backend" cmd /k "cd /d d:\Investment\pms\chat-backend && python app.py"
...
start "Backend Server" cmd /k "cd /d d:\Investment\pms\backend && mvn spring-boot:run"
...
start "Frontend Server" cmd /k "cd /d d:\Investment\pms\frontend && npm start"
